...
<!--  <a href="#" class="w3-bar-item w3-button"><i class="fa fa-envelope"></i></a> 
  ...
  <div class="w3-bar-block">
	...
	<a href="./supplier/dashboard" class="w3-bar-item w3-button w3-padding"><i class="fa fa-dashboard fa-fw"></i>  Dashboard</a>
    <a href="./material" class="w3-bar-item w3-button w3-padding"><i class="fa fa-bank fa-fw"></i>  My Material</a>
    <a href="./orders" class="w3-bar-item w3-button w3-padding"><i class="fa fa-diamond fa-fw"></i>  Orders</a>
    <a href="./group" class="w3-bar-item w3-button w3-padding  w3-blue"><i class="fa fa-users fa-fw"></i>  Group Members</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-users"></i> My Group Members</b></h5>
  </header>
  ...
  <div class="w3-container">
    ...
    <br>
    <button class="w3-button w3-dark-grey">Manage Members<i class="fa fa-arrow-right"></i></button>
    <p></p>
  </div>
  <p></p>
