...
<!--  <a href="#" class="w3-bar-item w3-button"><i class="fa fa-envelope"></i></a> 
  ...
  <div class="w3-bar-block">
    ...
    <a href="./myInfo" class="w3-bar-item w3-button w3-padding  w3-blue"><i class="fa fa-bullseye fa-fw"></i>  My Information</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-container">
    ...
    <br>
    <button class="w3-button w3-dark-grey">Manage Information<i class="fa fa-arrow-right"></i></button>
    <p></p>
  </div>
  <p></p>
