...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="./product" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-bank fa-fw"></i>  My Product</a>
    <a href="./ordersfrom" class="w3-bar-item w3-button w3-padding"><i class="fa fa-diamond fa-fw"></i>  Orders From Distributor</a>
    <a href="./myorders" class="w3-bar-item w3-button w3-padding"><i class="fa fa-history fa-fw"></i>   My Orders</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-dashboard"></i> My Product</b></h5>
  </header>
  ...
  <div class="w3-container">
    ...
    <br>
    <button class="w3-button w3-dark-grey">Manage Product<i class="fa fa-arrow-right"></i></button>
    <p></p>
  </div>
  <p></p>
